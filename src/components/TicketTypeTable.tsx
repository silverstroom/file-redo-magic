      ...
      <Table>
        <TableHeader>
          <TableRow className="border-border">
            <TableHead className="text-muted-foreground text-[10px] font-semibold uppercase tracking-wide">Tipologia</TableHead>
            <TableHead className="text-muted-foreground text-[10px] font-semibold uppercase tracking-wide">Giorni</TableHead>
            <TableHead className="text-right text-muted-foreground text-[10px] font-semibold uppercase tracking-wide">Venduti</TableHead>
            <TableHead className="text-right text-muted-foreground text-[10px] font-semibold uppercase tracking-wide w-14">%</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {rows.map((row, i) => {
              ...
              <TableRow key={i} className="border-border/50 hover:bg-muted/30">
                ...
                <TableCell>
                  <div className="flex flex-wrap gap-1">
                    {row.days.map((d) => (
                      <Badge key={d} variant="secondary" className="text-[9px] font-mono px-1.5 py-0 rounded-md">
                        {d}
                      </Badge>
                    ))}
                  </div>
