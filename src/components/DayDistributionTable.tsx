      ...
      <Table>
        <TableHeader>
          <TableRow className="border-border">
            <TableHead className="text-muted-foreground text-[10px] font-semibold uppercase tracking-wide">Giorno</TableHead>
            <TableHead className="text-muted-foreground text-[10px] font-semibold uppercase tracking-wide">Distribuzione</TableHead>
            <TableHead className="text-right text-muted-foreground text-[10px] font-semibold uppercase tracking-wide">Presenze</TableHead>
        ...
        <TableBody>
          {distribution.map((day, i) => {
            ...
            return (
              <TableRow key={day.date} className="border-border/50 hover:bg-muted/30">
